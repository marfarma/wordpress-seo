...
class WPSEO_Pointers {
	...
	jQuery(document).ready( function() { 
		...
		jQuery('#pointer-close').after('<a id="tour-close" class="button-secondary">' + <?php _e( "'Stop Tour'", 'wordpress-seo' ); ?> + '</a>');
